...
```sh
grep -rl 'ecoshop' ./ | xargs sed -i '' 's/ecoshop/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with ecoshop
...
Want to contribute? Ping us on `ecoshop` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/ecoshop.git
    cd ecoshop
    ```
...
- [ecoshop integration Documentation](https://docs.vuestorefront.io/ecoshop)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `ecoshop` channel on [our Discord](discord.vuestorefront.io).
